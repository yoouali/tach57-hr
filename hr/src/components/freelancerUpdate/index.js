                        ...
                        <div className="entrepreneurUpdateForm">
                            ...
                            <div className="entrepreneurUpdateFormSection">
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >Prenom</label>
                                    <input type="text" name="Prenom" placeholder={freelancer.Prenom}
                                           onChange={(e) => setFormData({...formData, Prenom: e.target.value})}
                                           value={formData.Prenom}></input>
                                </div>
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >Nom</label>
                                    <input type="text" name="Nom" placeholder={freelancer.Nom}
                                           onChange={(e) => setFormData({...formData, Nom: e.target.value})}
                                           value={formData.Nom}></input>
                                </div>
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >Email</label>
                                    <input type="email" name="Email" placeholder={freelancer.Email}
                                           onChange={(e) => setFormData({...formData, Email: e.target.value})}
                                           value={formData.Email}></input>
                                </div>
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >CIN</label>
                                    <input type="text" name="CIN" placeholder={freelancer.CIN}
                                           onChange={(e) => setFormData({...formData, CIN: e.target.value})}
                                           value={formData.CIN}></input>
                                </div>
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >TEL</label>
                                    <input type="text" name="TEL" placeholder={freelancer.TEL}
                                           onChange={(e) => setFormData({...formData, TEL: e.target.value})}
                                           value={formData.TEL}></input>
                                </div>
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >Adresse</label>
                                    <input type="text" name="TEL" placeholder={freelancer.Adresse}
                            ...
                            <div className="entrepreneurUpdateFormSection">
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >Sujet</label>
                                    <input type="text" name="CIN" placeholder={freelancer.Sujet}
                                           onChange={(e) => setFormData({...formData, Sujet: e.target.value})}
                                           value={formData.Sujet}></input>
                                </div>
                                <div className="entrepreneurUpdateInputGroupe">
                                ...
                                <div className="entrepreneurUpdateInputGroupe">
                                    ...
                                    <input type="text" name="CIN" placeholder={freelancer.Portefolio}
                                           onChange={(e) => setFormData({...formData, Portefolio: e.target.value})}
                                           value={formData.Portefolio}></input>
                                </div>
                                <div className="entrepreneurUpdateInputGroupe">
                                    <label >CV</label>
                            ...
                            <div className="entrepreneurUpdateFormButoon">
                               ...
                               <Link to={"/freelancer/" + freelancer.id}> <button id="enterpreneurButoonCancel">Cancel</button></Link>
                            </div>
                        </div>
                        </form>
                </div>
